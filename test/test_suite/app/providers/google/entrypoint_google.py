...
from .service.check_proxy_currency_service import check_proxy_currency_service

def entrypoint_google(params : UserInput) -> Any:
    if params["request_type"] == "PROXY_TESTING":
        test_results = check_proxy_currency_service(params)
        with open("test/test_suite/app/providers/google/debug/proxy_testing.json", "w") as f:
